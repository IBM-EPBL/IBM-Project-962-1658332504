...
client = Cloudant.iam('bef6fb8d-7b62-4e71-ac40-a336fb0adc68-bluemix', '1gwyAbXvEWJ2coE5iuPwbY6n_oJgDwA6LNgczntSPPY7',connect=True)
...
def res():
    webcam = cv2.VideoCapture('drowning-girl-1000w.jpg')
